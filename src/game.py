...
def main(window):
   ...
   message = f"Nhan vat ban chon :  {selected_character}"
   ...
   banana = Banana(block_size * 2, HEIGHT - block_size - 64, 32, 32)
   apple = Apple(block_size * 3, HEIGHT - block_size - 64, 32, 32)
